...
- Vision-Language Action Models / Robot Foundaton Models for Humanoids
- (Inverse) reinforcement learning for manipulation constraint learning
...
- Familiarity with state-of-the-art robot learning
- Experience using manipulator or humanoid robots
...
Open until filled. Applications will be considered on a rolling basis. The initial term is one or two years, with a possible extension depending on performance. The selected candidate will be supported by the InnoCORE Global Postdoctoral Fellowship program, which offers a competitive annual salary of approximately KRW 90 million.
